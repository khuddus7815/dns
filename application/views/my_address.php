<section class="section-b-space margin-top">
    <div class="container">
        <div class="row">
            <?php $this->load->view('common/profile_sidebar', ['active_tab' => 'address']); ?>

            <div class="col-lg-9">
                <div class="dashboard-right">
                    <div class="dashboard dashboard-address-body" style="display:block;">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editAddressForm" class="theme-form">
                    ...
                    <div class="form-group"><input type="text" class="form-control" name="state" id="edit_state"
                            required></div>
