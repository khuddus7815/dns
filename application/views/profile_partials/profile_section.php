<div class="page-title text-center">
    <label for="uploadImage" class="upload-image-label">
        <?php if (!empty($details->user_image)) { ?>
            <img src="<?php echo base_url('upload/profileimg/' . $details->user_image); ?>" class="dashboard-profile-img"
                id="userImage">
        <?php } else { ?>
            <img src="<?= base_url('assets/images/fashion/lookbook/1.jpg'); ?>" class="dashboard-profile-img"
                id="userImage">
        <?php } ?>
...
<div class="box-account box-info">
    <div class="box">
        ...
        <div class="mt-3 text-center">
            <button type="button" class="btn btn-solid" data-bs-toggle="modal" data-bs-target="#changepassword">
                Forgot Password
            </button>
        </div>
    </div>
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        if (response.success) {
                            ...
                            // Reload profile section instead of full page
